...
zernike mesh_exact_integrate(const mesh &m, int n, const triquad_selector &ts, bool verbose = false);
zernike mesh_approx_integrate(const mesh &m, int n, double error, const triquad_selector &ts, bool verbose = false);
